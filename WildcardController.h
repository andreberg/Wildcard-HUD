...
@property (retain) id wildcardWindow;
@property (retain) id findNameTextField;
@property (retain) id ignoreCaseCheckBox;
@property (retain) id regexCheckBox;
@property (retain) id replaceNameTextField;
@property (retain) id showFinderCheckBox;
@property (retain) id statusTextField;
@property (retain) id findPopUp;
@property (retain) id replaceTitle;
@property (retain) id desktopCheckBox;
@property (retain) id renameButton;
@property BOOL	_findInComment;
@property int		_targetWindowID;
@end
